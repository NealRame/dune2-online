...
// >(target: TConstructor<IEntityLifecycleHooks<Data, Events>>)
...
//         IMixins extends Array<unknown>
//     >(EntityHooks: TConstructor<IEntityLifecycleHooks<Data, Events>>): IEntity<Data, Events> & TupleToIntersection<IMixins>
...
//         Events extends IEntityEvents,
//         IMixins extends Array<unknown>,
//     >(EntityHooks: TConstructor<IEntityLifecycleHooks<Data, Events>>)
